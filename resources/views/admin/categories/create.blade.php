...
@section('title', __t('admin.add_category'))
@section('breadcrumb', __t('admin.panel') . ' / ' . __t('admin.nav_categories') . ' / ' . __t('admin.add_category'))
        ...
        <form method="POST" action="{{ route('admin.categories.store') }}" class="space-y-4">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <input type="text" name="name_translations[{{ $locale }}]"
                               ...
                               placeholder="{{ $locale === 'az' ? 'Meyvələr' : 'Fruits' }}">
                    </div>
                    @endforeach
                </div>
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                <div>
                    <label class="block text-xs font-semibold text-gray-600 mb-1.5">
                        {{ __t('admin.col_icon') }}
                        <span class="text-gray-400 font-normal">(emoji)</span>
                    </label>
                ...
                <div>
                    ...
                    <input type="text" name="color" value="{{ old('color') }}" maxlength="20"
